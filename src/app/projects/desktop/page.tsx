    ...
    <div className="pt-24 pb-20">
      <div className="mx-auto max-w-4xl px-6">
        <div className="flex items-center gap-2 text-sm text-text-secondary mb-8">
          ...
          <span>/</span>
          <span className="text-text-primary">R2ND Desktop</span>
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold">R2ND Desktop</h1>
              <p className="text-text-secondary mt-1">Complete desktop environment</p>
            </div>
          </div>
        ...
        <motion.section className="mb-16" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          ...
          <p className="text-text-secondary leading-relaxed text-lg">
            R2ND Desktop is a complete desktop environment built entirely within the R2ND ecosystem.
            It includes a window manager, compositor, application launcher, and a full suite of native
            applications — all built from scratch using M++ and the R2ND UI engine.
          </p>
        </motion.section>
        ...
        <motion.section className="mb-16" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              "Native window capture and compositing",
              "Multiple environment modes",
              "Built-in visual UI builder",
              "Virtual workspace switching",
              "Fully modular application system",
              "Native file manager, terminal, and editor",
              "System monitor and process management",
              "Custom theming and layout engine",
            ].map((f) => (
        ...
        <motion.section className="mb-16" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <h2 className="text-2xl font-bold mb-6">Architecture</h2>
          <div className="code-block">
            <pre className="text-sm leading-8 text-text-secondary">
{`┌─────────────────────────────────┐
│         Applications            │
│   File Manager  Terminal  Editor│
├─────────────────────────────────┤
│       R2ND Desktop Shell        │
│   Launcher  Taskbar  Notifs     │
├─────────────────────────────────┤
│      Window Manager / WM        │
...
└─────────────────────────────────┘`}
        ...
        <motion.div className="flex flex-wrap gap-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
          ...
          <a href="https://github.com/mathiassol/r2nd" target="_blank" rel="noopener noreferrer"
