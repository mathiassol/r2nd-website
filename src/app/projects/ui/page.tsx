      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold">R2ND UI</h1>
              <p className="text-text-secondary mt-1">Custom UI rendering engine with hardware acceleration</p>
            </div>
          </div>
        ...
        <motion.section className="mb-16" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          ...
          <p className="text-text-secondary leading-relaxed text-lg">
            R2ND UI is a fully custom UI rendering engine designed from the ground up to leverage hardware
            acceleration without relying on any existing GUI frameworks or browser engines. It implements
            its own layout engine, event propagation system, and compositing pipeline, giving the R2ND
            ecosystem complete control over how interfaces are drawn and interacted with across all
            supported platforms.
          </p>
        </motion.section>
