    ...
    <div className="pt-24 pb-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="flex items-center gap-2 text-sm text-text-secondary mb-8">
          ...
          <span>/</span>
          <span className="text-text-primary">R2ND Renderer</span>
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold">R2ND Renderer</h1>
              <p className="text-text-secondary mt-1">3D rendering pipeline built from scratch</p>
            </div>
          </div>
        ...
        <motion.section className="mb-16" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          ...
          <p className="text-text-secondary leading-relaxed text-lg">
            R2ND Renderer is a 3D rendering pipeline written entirely from scratch, with no dependency on
            existing graphics abstraction layers like OpenGL or Vulkan wrappers. It manages everything from
            shader compilation and scene graph traversal to mesh processing and lighting calculations,
            providing a lean and fully understood rendering stack that integrates tightly with the rest of
            the R2ND ecosystem.
          </p>
        </motion.section>
