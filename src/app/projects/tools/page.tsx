    ...
    <div className="pt-24 pb-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="flex items-center gap-2 text-sm text-text-secondary mb-8">
          ...
          <span>/</span>
          <span className="text-text-primary">R2ND Tools</span>
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold">R2ND Tools</h1>
              <p className="text-text-secondary mt-1">Developer toolchain for the R2ND ecosystem</p>
            </div>
          </div>
        ...
        <motion.section className="mb-16" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          ...
          <p className="text-text-secondary leading-relaxed text-lg">
            R2ND Tools is the official developer toolchain for the R2ND ecosystem, providing everything a
            developer needs to build, debug, profile, and ship software written in M++ and targeting R2ND
            platforms. Rather than patching together third-party utilities, R2ND Tools is purpose-built for
            the ecosystem — covering the full development lifecycle from writing and formatting code to
            generating documentation and managing packages, all through a unified and consistent interface.
          </p>
        </motion.section>
