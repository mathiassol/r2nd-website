      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center font-mono font-bold text-accent">
              {"{ }"}
            </div>
            <div>
        ...
        >
          ...
          <p className="text-text-secondary leading-relaxed text-lg">
            M++ is a low-level compiled programming language designed for the
            R2ND ecosystem. It compiles through LLVM for optimized native code
            generation across platforms. M++ gives developers full control over
            memory and performance while providing modern language ergonomics.
          </p>
        </motion.section>
          ...
          <div className="code-block">
            ...
            <pre className="text-sm leading-7">
              <code>
                ...
                {"\n"}
                {"    "}
                <span className="text-text-secondary">let</span>{" "}
                ...
                {"\n"}
                {"    "}
                <span className="text-text-primary">print</span>
                <span className="text-text-secondary">(</span>
                <span className="text-text-primary">message</span>
                <span className="text-text-secondary">);</span>
                {"\n"}
        ...
        >
          <Link
            href="/docs"
            className="px-6 py-3 rounded-lg bg-accent text-white hover:bg-accent-hover font-medium text-sm transition-all shadow-sm"
          >
            Read Documentation
          </Link>
          <a
